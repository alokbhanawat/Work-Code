...
class PermanentEmployee extends Employee {
    ...
    public void calculateMonthlySalary() {
        ...
        double monthlySalary = this.basicPay + this.hra + variableComponent;
        this.setSalary(monthlySalary);
        System.out.println("Permanent Employee Monthly Salary: " + monthlySalary);
    }
...
class ContractEmployee extends Employee {
    ...
    public void calculateSalary() {
        double monthlySalary = this.wage * this.hoursWorked;
        this.setSalary(monthlySalary);
        System.out.println("Contract Employee Monthly Salary: " + monthlySalary);
    }
